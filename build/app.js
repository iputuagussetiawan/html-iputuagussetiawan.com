  ...
  _createClass(Navigation, [{
    ...
    value: function events() {
      ...
      this.backtop.addEventListener('click', function () {
        _this2.scroll.scrollTo(0);
      });
      this.themeButton.addEventListener('click', function () {
        // Add or remove the dark / icon theme
        _this2.body.classList.toggle(_this2.darkTheme);

        _this2.themeButton.classList.toggle(_this2.iconTheme); // We save the theme and the current icon that the user chose


        localStorage.setItem('selected-theme', _this2.getCurrentTheme());
        localStorage.setItem('selected-icon', _this2.getCurrentIcon());
      });
      this.burgerMenu.addEventListener("click", function () {
        return _this2.burgerTime();
      });
      this.scroll.on("scroll", function (position) {
        _this2.scrollActive(position.scroll.y);

        if (position.scroll.y > 250) {
          _this2.navbarCustom.classList.add("show");
        } else {
          _this2.navbarCustom.classList.remove("show");
        }
      });
      ...
      this.sideNavLink.forEach(function (el) {
        el.addEventListener("click", function (e) {
          ...
          _this2.scroll.scrollTo(link, {
            offset: -64
          });

          _this2.closeSideMenu(); // gsap.to(window, {duration: 0.75, scrollTo: link, ease: "power2"});
    ...
    value: function scrollActive(scrollY) {
      this.sections.forEach(function (current) {
        ...
        var curentMenu = document.querySelector('.side-menu a[href*=' + sectionId + ']'); //console.log(sectionId);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_0___default().get(profileCompanyData.root_url + "/wp-json/companyprofile/v1/search?term=" + this.searchField.value);

              case 3:
                response = _context.sent;
                results = response.data;
                this.resultsDiv.innerHTML = "\n        <div class=\"row\">\n          <div class=\"col-md-4 one-third\">\n            <h2 class=\"search-overlay__section-title\">General Information</h2>\n            ".concat(results.generalInfo.length ? '<ul class="search-list">' : "<p>No general information matches that search.</p>", "\n              ").concat(results.generalInfo.map(function (item) {
                  return "<li class=\"search-list__item\"><a class=\"search-list__link\" href=\"".concat(item.permalink, "\">").concat(item.title, "</a> ").concat(item.postType == "post" ? "by ".concat(item.authorName) : "", "</li>");
                }).join(""), "\n            ").concat(results.generalInfo.length ? "</ul>" : "", "\n          </div>\n          <div class=\"col-md-4 one-third\">\n            <h2 class=\"search-overlay__section-title\">FAQS</h2>\n            ").concat(results.faqs.length ? '<ul class="search-list">' : "<p>No faqs match that search.</p><a href=\"".concat(profileCompanyData.root_url, "/portfolio\">View all Portfolio</a>"), "\n              ").concat(results.faqs.map(function (item) {
                  return "<li class=\"search-list__item\">\n              <a class=\"search-list__link\" href=\"".concat(item.permalink, "\">\n                <div class=\"search-list__info-container\">\n                  <h3 class=\"search-list__title\">").concat(item.title, "</h3>\n                  <p class=\"search-list__excerpt\">").concat(item.excerpt, "</p>\n                </div>\n              </a>\n              </li>");
                }).join(""), "\n            ").concat(results.faqs.length ? "</ul>" : "", "\n          </div>\n\n          <div class=\"col-md-4 one-third\">\n          <h2 class=\"search-overlay__section-title\">Portfolio</h2>\n          ").concat(results.ourwork.length ? '<ul class="search-list">' : "<p>No Portfolio match that search.</p>", "\n            ").concat(results.ourwork.map(function (item) {
                  return "\n              <li class=\"search-list__item\">\n                <a class=\"search-list__link\" href=\"".concat(item.permalink, "\">\n                  <div class=\"search-list__image-container\">\n                    <img class=\"search-list__image\" src=\"").concat(item.image, "\">\n                  </div>\n                  <div class=\"search-list__info-container\">\n                    <h3 class=\"search-list__title\">").concat(item.title, "</h3>\n                    <p class=\"search-list__excerpt\">").concat(item.excerpt, "</p>\n                  </div>\n                </a>\n              </li>\n            ");
                }).join(""), "\n          ").concat(results.ourwork.length ? "</ul>" : "", "\n\n        </div>\n        </div>");
                this.isSpinnerVisible = false;
                _context.next = 12;
                break;
...
/* harmony import */ var js_circle_progress__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! js-circle-progress */ "./node_modules/js-circle-progress/dist/circle-progress.js");
/* harmony import */ var js_circle_progress__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(js_circle_progress__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js");
/* harmony import */ var _js_layout_search__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../js/layout/search */ "./src/js/layout/search.js");
/* harmony import */ var _js_layout_navigation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../js/layout/navigation */ "./src/js/layout/navigation.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var typed = new (typed_js__WEBPACK_IMPORTED_MODULE_1___default())('#typed', {
...
var observer = new IntersectionObserver(function (progressBars) {
  progressBars.forEach(function (progressBar) {
    if (progressBar.isIntersecting) {
      var fill = progressBar.target.getAttribute('data-fill');
      var skillName = progressBar.target.innerHTML;
...
var accordionItems = document.querySelectorAll('.questions__item');
accordionItems.forEach(function (item) {
  var accordionHeader = item.querySelector('.questions__header');
  accordionHeader.addEventListener('click', function () {
    var openItem = document.querySelector('.accordion-open');
    toggleItem(item);
...
function toggleItem(item) {
  var accordionContent = item.querySelector('.questions__content');
...
window.addEventListener("load", function () {
  ...
  loader.to(".loader__circle-container", {
    ...
    duration: 1.75,
    yPercent: -100,
    ease: "expo.inOut" //onComplete: bannerAnimation,

  });
  var search = new _js_layout_search__WEBPACK_IMPORTED_MODULE_3__["default"]();
  var navigation = new _js_layout_navigation__WEBPACK_IMPORTED_MODULE_4__["default"]();
  var progress, progressLabel;
  var circles = document.querySelectorAll('.circleprogress');

  for (var i = 0; i < circles.length; i++) {
    progress = circles[i].getAttribute('data-percent');
    progressLabel = circles[i].getAttribute('data-label');
    var circleprogress = new (js_circle_progress__WEBPACK_IMPORTED_MODULE_2___default())('.progress' + progressLabel, {
      value: progress,
      max: 100,
      textFormat: 'percent'
    });

...
<div class="main-slider-img-text slide-type-two pera-content headline position-relative">
    ...
    <div class="container">
        <div class="slider-content-box text-center">
            <span class="title-tag text-uppercase"><img src="<?php echo get_template_directory_uri() ?>/assets/icon/icon5.svg" alt="<?php echo get_sub_field('banner_subtitle'); ?>"><?php echo get_sub_field('banner_subtitle'); ?></span>
